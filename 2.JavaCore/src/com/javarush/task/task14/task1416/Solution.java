...
public class Solution {
    ...
    static abstract class Orca extends OceanAnimal{
    }

    static abstract class Whale extends OceanAnimal{

    }

    static abstract class Otter implements Walkable,Swimmable{
